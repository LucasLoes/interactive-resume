...
### Interactive Resume — Lucas Ladeira Loes

**[🇧🇷 Português](#-português) · [🇺🇸 English](#-english)**

[![GitHub Pages](https://img.shields.io/badge/GitHub%20Pages-Live-brightgreen?style=flat-square&logo=github)](https://lucasloes.github.io/interactive-resume/)
[![HTML5](https://img.shields.io/badge/HTML5-Semântico-E34F26?style=flat-square&logo=html5&logoColor=white)](https://lucasloes.github.io/interactive-resume/)
[![Tailwind CSS](https://img.shields.io/badge/Tailwind%20CSS-Design%20System-06B6D4?style=flat-square&logo=tailwindcss&logoColor=white)](https://lucasloes.github.io/interactive-resume/)
[![JavaScript](https://img.shields.io/badge/JavaScript-Vanilla%20ES6+-F7DF1E?style=flat-square&logo=javascript&logoColor=black)](https://lucasloes.github.io/interactive-resume/)
[![GSAP](https://img.shields.io/badge/GSAP-Animações-88CE02?style=flat-square&logo=greensock&logoColor=black)](https://lucasloes.github.io/interactive-resume/)

🔗 **[https://lucasloes.github.io/interactive-resume/](https://lucasloes.github.io/interactive-resume/)**
...
Currículo web interativo de alto impacto visual para **Analista de TI Sênior & Administrador Google Workspace**, desenvolvido como uma **Single Page Application (SPA)** moderna, responsiva e bilíngue — sem frameworks pesados, apenas HTML5 semântico, Tailwind CSS e JavaScript puro.
...
- **Tailwind CSS** — design system com glassmorphism, gradientes e micro-interações
- **Vanilla JavaScript (ES6+)** — arquitetura reativa leve, sem dependências de framework
- **GSAP & ScrollTrigger** — animações de entrada, contadores numéricos e efeitos suaves
- **Google Fonts** — *Plus Jakarta Sans*, *Inter* e *Fira Code*
- **GitHub Pages** — hospedagem gratuita com deploy automático via push

---

## 🇺🇸 English

A high-impact interactive web resume for a **Senior IT Analyst & Google Workspace Administrator**, built as a modern, responsive, and bilingual **Single Page Application (SPA)** — no heavy frameworks, just semantic HTML5, Tailwind CSS, and vanilla JavaScript.
...
- **Tailwind CSS** — design system with glassmorphism, gradients, and micro-interactions
- **Vanilla JavaScript (ES6+)** — lightweight reactive architecture, zero framework dependencies
- **GSAP & ScrollTrigger** — entrance animations, numeric counters, and smooth effects
- **Google Fonts** — *Plus Jakarta Sans*, *Inter*, and *Fira Code*
- **GitHub Pages** — free hosting with automatic deployment on push

---

<div align="center">

**© 2026 Lucas Ladeira Loes** · [LinkedIn](https://www.linkedin.com/in/lucas-ladeira-loes/) · [lucasladeiraloes@gmail.com](mailto:lucasladeiraloes@gmail.com)
